...
<head>
	...
	<title>TechHires - Job Portal</title>
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/02.jpg');">
				<div class="container">
					...
					<h1>Get hired on HiredTech</h1>
					<p>We provide you access to top job opportunities to boost your career</p>
